...
logger = logging.getLogger("floseup_80")

class TaskSolutionService:
    """
    Serviço modular de solução técnica para a issue FLOSEUP-80.
    """
...
def test_task_solution_service() -> None:
    ...
    assert out["issue_id"] == "FLOSEUP-80"
